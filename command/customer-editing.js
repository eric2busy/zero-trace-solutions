(() => {
  ...
  style.textContent = `
    .customer-edit-actions{display:flex;gap:7px;align-items:center}.customer-edit-form,.customer-history{grid-column:1/-1;display:grid;gap:10px;padding:12px 0 4px}.customer-history{border-top:1px solid var(--border);font-size:11px}.customer-history-title{font-weight:700;color:var(--dark)}.customer-history-row{display:flex;justify-content:space-between;gap:10px;color:var(--quiet)}.customer-edit-grid{display:grid;grid-template-columns:1fr;gap:9px}.customer-edit-field label{display:block;font-size:9px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:var(--quiet);margin:0 0 5px}.customer-edit-field input,.customer-edit-field select,.customer-edit-field textarea{width:100%;border:1px solid var(--border);border-radius:12px;background:var(--surface-raised);padding:10px 11px;color:var(--dark);outline:none;color-scheme:light}.customer-edit-field select option{background:var(--surface-raised);color:var(--dark)}.customer-edit-field input::placeholder,.customer-edit-field textarea::placeholder{color:var(--quiet);opacity:1}.customer-edit-field input:focus,.customer-edit-field select:focus,.customer-edit-field textarea:focus{border-color:var(--primary);box-shadow:0 0 0 4px rgba(0,131,245,.18)}.customer-edit-field input:disabled,.customer-edit-field select:disabled,.customer-edit-field textarea:disabled,.customer-edit-field input[readonly],.customer-edit-field textarea[readonly]{background:var(--surface);color:var(--quiet);cursor:not-allowed}.customer-edit-buttons{display:grid;grid-template-columns:1fr 1fr;gap:8px}.customer-save{border:1px solid var(--primary);background:var(--primary);color:#fff;border-radius:12px;padding:10px;font-size:11px;font-weight:700}.customer-cancel{border:1px solid var(--border);background:var(--surface-raised);color:var(--dark);border-radius:12px;padding:10px;font-size:11px;font-weight:700}.customer-save:disabled,.customer-cancel:disabled{opacity:.55;cursor:not-allowed}:root[data-theme="dark"] .customer-edit-field input,:root[data-theme="dark"] .customer-edit-field select,:root[data-theme="dark"] .customer-edit-field textarea{color-scheme:dark}@media(min-width:600px){.customer-edit-grid{grid-template-columns:2fr 1fr}}
  `;
